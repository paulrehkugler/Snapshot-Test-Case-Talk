...
struct DeviceOrientation {
    ...
    static func iPhone4Landscape() -> DeviceOrientation {
        return DeviceOrientation(
            ...
            screenSize: CGSize(width: 480, height: 320),
            name: "iPhone4Landscape")
    }
    ...
    static func iPhone5Landscape() -> DeviceOrientation {
        return DeviceOrientation(
            horizontalSizeClass: .Compact,
            verticalSizeClass: .Compact,
            screenSize: CGSize(width: 568, height: 320),
            name: "iPhone5Landscape")
    }
    ...
    static func iPhone6Landscape() -> DeviceOrientation {
        return DeviceOrientation(
            horizontalSizeClass: .Compact,
            verticalSizeClass: .Compact,
            screenSize: CGSize(width: 667, height: 375),
            name: "iPhone6Landscape")
    }
    ...
    static func iPhone6PlusLandscape() -> DeviceOrientation {
        return DeviceOrientation(
            ...
            verticalSizeClass: .Compact,
            screenSize: CGSize(width: 736, height: 414),
            name: "iPhone6PlusLandscape")
    }
    ...
    static func iPadProLandscape() -> DeviceOrientation {
        return DeviceOrientation(
            horizontalSizeClass: .Regular,
            verticalSizeClass: .Regular,
            screenSize: CGSize(width: 1366, height: 1024),
            name: "iPadProLandscape")
    }
